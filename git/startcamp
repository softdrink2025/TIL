...
-> 메세지 수정 :
기본은 명령어 모드. i를 누르면 insert mode로 바꿀 수 있음.
내용 수정 후 ESC 누르면 insert mode 종료, 명령어 모드로
: ( 쉬프트 + ; ) 누르면 하단에 : 뜨고 입력할 수 있음
wq - 저장 후 종료
q - 종료
wq! - 저장 후 강제 종료
q! 강제 종료
...
-> 직전 commit 수정
직전 수정 내용을 add로 추가함
git commit --amend에 들어가면 수정 내용이 들어가 있는 것 확인
위와 같은 방법으로 종료

[ GitHub vs GitLab ] 
GitHub - MS꺼. 코드를 마소가 다 가져가버림
